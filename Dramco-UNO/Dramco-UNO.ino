...
#elif DEVICE == 19  //Tree node9
// LoRaWAN NwkSKey, network session key
static const PROGMEM u1_t NWKSKEY[16] = { 0x4C, 0x0D, 0xB8, 0x29, 0x22, 0x85, 0xE6, 0x8B, 0xDA, 0xA0, 0xE2, 0xE6, 0x1D, 0xA0, 0xB4, 0x1D };
// LoRaWAN AppSKey, application session key
static const u1_t PROGMEM APPSKEY[16] = { 0x03, 0xC3, 0xE5, 0x9C, 0xF5, 0xB1, 0x09, 0x9C, 0x67, 0x65, 0xA0, 0x80, 0xEC, 0x59, 0xFA, 0x13 };
// LoRaWAN end-device address (DevAddr)
static const u4_t DEVADDR = 0x26011663;
